  ...
  async findLawyersWithinRadius({ longitude, latitude, radius }) {
    if (env === "production") {
      ...
      return models.sequelize.query(
        `SELECT "Users"."id", "Users"."firebaseToken", "Users"."firstName", "Users"."email", "LocationDetails"."location" FROM "LocationDetails" INNER JOIN "Users" ON "LocationDetails"."id" = "Users".id WHERE ST_DWithin((location)::geography, ST_SetSRID(ST_MakePoint(:longitude,:latitude)::geography, 4326),:radius) AND "LocationDetails"."assigningId" IS NULL AND "LocationDetails"."online" = true AND "Users"."role" = 'lawyer'`,
        {
      ...
      return models.sequelize.query(
        `SELECT "Users"."id", "Users"."firebaseToken", "Users"."firstName", "Users"."email", "LocationDetails"."location" FROM "LocationDetails" INNER JOIN "Users" ON "LocationDetails"."id" = "Users".id WHERE ST_DWithin((location)::geography,ST_MakePoint(:longitude,:latitude)::geography,:radius) AND "LocationDetails"."assigningId" IS NULL AND "LocationDetails"."online" = true AND "Users"."role" = 'lawyer'`,
        {
          type: QueryTypes.SELECT,
          replacements: { longitude, latitude, radius },
        }
